...
public class ProductController {
    ...
    @GetMapping(value = {"/"})
    public String list(Model model, @PageableDefault(size = 4) Pageable pageable, @RequestParam Optional<String> key) {
        String keywordVal = key.orElse("");
        model.addAttribute("productList", iProductService.findAllByNameOfProduct(keywordVal, pageable));
